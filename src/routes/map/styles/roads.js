export default  {
  ...
  sources: {
    openmaptiles: {
      type: "vector",
      // If you have a SINGLE endpoint returning multiple layers in the same tile:
      tiles: ["http://localhost:8888/tiles/{z}/{x}/{y}"]
      // If each layer is a separate endpoint, you’d define multiple source entries.
    },
  },
