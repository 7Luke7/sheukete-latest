import { createEffect, createSignal, For, on, createMemo, batch } from "solid-js";
import { SingleNotification } from "../../SingleNotification";
import { get_unread_user_notifications } from "~/routes/api/notifications/users";
import { createAsync } from "@solidjs/router";

const UnreadUserNotifications = () => {
    const initialNotifications = createAsync(get_unread_user_notifications, {
        deferStream: true,
      });
      ...
      const fetchData = async () => {
        ...
        try {
          const data = await get_unread_user_notifications(
...
export default UnreadUserNotifications;